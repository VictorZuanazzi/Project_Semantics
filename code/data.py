...
class SNLIDataset(DatasetTemplate):
	...
	def load_data(self, data_path, data_type):
		self.data_list = list()
		self.num_invalids = 0
		s1 = [line.rstrip() for line in open(data_path + "/s1." + data_type, 'r',encoding = 'utf-8')]
		s2 = [line.rstrip() for line in open(data_path + "/s2." + data_type, 'r', encoding = 'utf-8')]
		labels = [NLIData.LABEL_LIST[line.rstrip('\n')] for line in open(data_path + "/labels." + data_type, 'r', encoding = 'utf-8')]
